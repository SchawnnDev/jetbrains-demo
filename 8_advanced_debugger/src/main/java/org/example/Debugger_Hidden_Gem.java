// Credits to Egor Ushakov
// https://github.com/gorrus/DebuggerHiddenGem
package org.example;
...
//        System.out.println(o.foo());
        ...
        public interface BaseInterface {
            String foo(); // unused? no, it is used with reflection so we cannot see them with static analysis
            String boo();
        }
    }
